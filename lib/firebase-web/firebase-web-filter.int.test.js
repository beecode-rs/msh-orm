...
const firebase_web_filter_1 = require("./firebase-web-filter");
const firestore_1 = require("firebase/firestore");
jest.mock('firebase/firestore');
describe('FirebaseFilter', () => {
    describe('filter', () => {
        it('should not filter data', () => {
            const result = firebase_web_filter_1.firebaseWebFilter.filter();
            expect(result).toBeUndefined();
        });
        describe('equal', () => {
            it('should filter data by id', () => {
                const result = firebase_web_filter_1.firebaseWebFilter.filter({ filter: { id: 3 } });
                expect(result).toEqual((0, firestore_1.where)('id', '==', 3));
            });
...
//# sourceMappingURL=firebase-web-filter.int.test.js.map